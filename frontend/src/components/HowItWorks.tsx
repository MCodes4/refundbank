...
const PHASES = [
  {
    ...
    body: "A buy or sell executes on pump.fun. One percent of the trade value is routed to the RefundBank creator fee account. The trader pays it without thinking about it.",
  },
  {
    time: "t+45s",
    title: "Holders are ranked.",
    body: "An automated scan reads every wallet holding $RFND. Each wallet's total SOL invested is compared against the current value of its tokens. The result is a ranked list, deepest loss at the top.",
  },
  {
    time: "t+120s",
